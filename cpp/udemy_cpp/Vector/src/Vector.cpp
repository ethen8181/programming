...
int main() {
    ...
    cout << "Sorting custom vectors" << endl;
    vector<Person> person;
    person.push_back(Person("Mike", 40));
    person.push_back(Person("Vicky", 30));
    person.push_back(Person("Raj", 20));
    ...
    while (testStack.size() > 0) {
    	int top = testStack.top();
    	cout << top << flush;
    	// keep in mind that pop will be destroying the original
