...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("/Users/ethen/programming/spark/sparkScala/code/Marvel-names.txt")
    val namesRdd = names.flatMap(parseNames)
   
    // Load up the superhero co-apperarance data
    val lines = sc.textFile("/Users/ethen/programming/spark/sparkScala/code/Marvel-graph.txt")
