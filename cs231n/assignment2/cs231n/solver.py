...
class Solver(object):
	...
	def _reset(self):
		...
		for p in self.model.params:
			d = copy.deepcopy(self.optim_config)
	...
	def train(self):
		...
		# make sure the batch size doesn't exceed the number of training samples
		...
		for t in range(num_iterations):
			...
			# decay the learning rate (multiply it with a ratio smaller than 1)
